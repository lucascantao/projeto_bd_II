...
--
-- Host: 127.0.0.1
-- Tempo de geração: 01/04/2025 às 07:25
...
(6, 1, 5, 'A equipe abriu uma transação e execultou atribuio um lock, após isso foi executado uma outra transação de leitura e escrita, onde a escrita ficou travada até a liberação da operação anterior', '2025-04-01 05:23:29', 'PENDENTE'),
(7, 1, 5, 'START TRANSACTION;\r\nSELECT saldo FROM Conta WHERE id = 1 LOCK IN SHARE MODE;', '2025-04-01 05:24:34', 'PENDENTE'),
(8, 1, 5, 'START TRANSACTION;\r\nSELECT saldo FROM Conta WHERE id = 1;\r\nUPDATE Conta SET saldo = saldo - 50 WHERE id = 1;', '2025-04-01 05:24:37', 'PENDENTE');
